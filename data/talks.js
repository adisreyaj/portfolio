export const TALKS = [
  ...
  {
    image: '/images/talks/angular-nation-july.jpg',
    title: 'You can create a directive for that',
    description: '',
    host: { name: 'Angular Nation', link: 'https://www.angularnation.net/' },
    ...
    links: [
      {
        type: 'video',
        url: 'https://vimeo.com/572131915/da43ea5621',
      },
      {
        type: 'git',
        url: 'https://github.com/adisreyaj/ng-directives',
      ...
      {
        type: 'slides',
        url: 'https://slides.com/adisreyaj/ng-directives#/intro',
      },
      {
        type: 'demo',
        url: 'https://ng-directives.vercel.app/',
